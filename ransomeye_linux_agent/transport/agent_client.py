# Path and File Name : /home/ransomeye/rebuild/ransomeye_linux_agent/transport/agent_client.py
# Author: nXxBku0CKFAJCBN3X1g3bQk7OxYQylg8CMw1iGsq7gU
# Details of functionality of this file: mTLS client using requests with certificate and key authentication
...
class AgentClient:
    ...
    def __init__(self):
        ...
        self.cert_path = os.environ.get('AGENT_CERT_PATH', '/etc/ransomeye-agent/certs/agent.crt')
        self.key_path = os.environ.get('AGENT_KEY_PATH', '/etc/ransomeye-agent/certs/agent.key')
        self.ca_cert_path = os.environ.get('CA_CERT_PATH', '/etc/ransomeye-agent/certs/ca.crt')
