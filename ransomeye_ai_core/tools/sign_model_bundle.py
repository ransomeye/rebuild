# Path and File Name : /home/ransomeye/rebuild/ransomeye_ai_core/tools/sign_model_bundle.py
# Author: nXxBku0CKFAJCBN3X1g3bQk7OxYQylg8CMw1iGsq7gU
# Details of functionality of this file: CLI tool to sign manifest.json using RSA private key
...
def main():
    parser = argparse.ArgumentParser(description='Sign model bundle manifest')
