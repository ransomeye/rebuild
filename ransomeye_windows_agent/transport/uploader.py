# Path and File Name : /home/ransomeye/rebuild/ransomeye_windows_agent/transport/uploader.py
...
class Uploader:
    ...
    def _upload_event(self, file_path: Path) -> bool:
        """
        Upload single event file to Core.
        ...
        try:
            # Load event
            event_data = self.persistence.load_event(file_path)
            ...
            # Upload to Core
            response = self.client.post('/api/v1/agent/events', event_data)
